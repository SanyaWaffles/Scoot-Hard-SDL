...
void KillActor (objtype *ob)
{
    ...
    switch (ob->obclass)
    {
        case guardobj:
            ...
            if(US_RndT()%3)
                PlaceItemType(bo_money1b,tilex,tiley);
            else
        ...
        case officerobj:
            ...
            if(US_RndT()%3)
               PlaceItemType(bo_money10b,tilex,tiley);
            else
               PlaceItemType(bo_clip2,tilex, tiley);
            break;
        ...
        case ssobj:
            ...
            if (gamestate.gotmachinegun == false)
                PlaceItemType (bo_machinegun,tilex,tiley);
            else
            {
                if(US_RndT()%3)
                    PlaceItemType(bo_money5b,tilex,tiley);
                else
                    PlaceItemType(bo_clip2,tilex, tiley);
            }
            
            if (achievements_unlocked[1] == false)
                SetAchievement(1);
            break;
        ...
        case bossobj:
            ...
            if (achievements_unlocked[5] == false)
                SetAchievement(5);
        ...
        case schabbobj:
            ...
            if (achievements_unlocked[6] == false)
                SetAchievement(6);
        ...
        case g4dashobj:
            ...
            if (achievements_unlocked[7] == false)
                SetAchievement(7);
            
            break;
        
        case glassobj:
            NewState(ob, &s_glass_die1);
            break;
        default:
            break;
    }
...
void FirstSighting (objtype *ob)
{
    int gd_guards[3] = {GUARD_SEE1_SND, GUARD_SEE2_SND, GUARD_SEE3_SND};
    int pp_guards[2] = {PEGPOL_SEE1_SND, PEGPOL_SEE2_SND};
    int en_guards[2] = {ENGIE_SEE1_SND, ENGIE_SEE2_SND};
    ...
    {
        case guardobj:
            PlaySoundLocActor(gd_guards[US_RndT()%3],ob);
            NewState (ob,&s_grdchase1);
            ob->speed *= 3;                 // go faster when chasing player
            break;

        case officerobj:
            PlaySoundLocActor(en_guards[US_RndT()%2],ob);
