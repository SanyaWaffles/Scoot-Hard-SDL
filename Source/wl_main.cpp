...
int     episodes_unlocked=1;

boolean achievements_unlocked[10];
char    achievement_text[128];
const char * achievement_strings[10] =
{
    "My First Pushwall",                // Pushing your first Pushwall
    "Buck the Police",                  // Killing your first PegPol Grunt
    "McClane Be Proud",                 // Getting a Machine Gun
    "Buy Some Apples",                  // Buy an apple from a vending machine
    "So Cash",                          // Get 100 tokens
    "Surprise!",                        // Defeat Surprise
    "Ozone Destruction",                // Defeat Dr. Atmosphere
    "Painbow",                          // Defeat Rainbow Dash
    "My Little Pwny",                   // Clear a single Level 100%
    "Dawn of a New Day"                 // Escape with Aurora
};

const char * achievement_defs[10] =
{
    "Uncover your first secret",
    "Kill your first PegPol Grunt",
    "Getting a Machine Gun",
    "Buy an Apple",
    "Get 100 bits in one episode",
    "Defeat Surprise",
    "Defeat Dr. Atmosphere",
    "Defeat Rainbow Dash",
    "Clear a single level 100%",
    "Escape with Aurora"
};
...
void ReadConfig(void)
{
    ...
    if (file != -1)
    {
        ...
        read(file,&episodes_unlocked,sizeof(episodes_unlocked));
        ...
        read(file,&achievements_unlocked,sizeof(achievements_unlocked));
...
void WriteConfig(void)
{
    ...
    if (file != -1)
    {
        ...
        write(file,&episodes_unlocked,sizeof(episodes_unlocked));
        ...
        write(file,&achievements_unlocked,sizeof(achievements_unlocked));
...
void CheckParameters(int argc, char *argv[])
{
    ...
    if(hasError || showHelp)
    {
        ...
        printf(
            "Scoot Hard\n"
            "Based on Wolf4SDL v1.8 SVN by Chaos Software\n"
            "Original Wolfenstein 3D by id Software\n\n"
            "Usage: Scoot Hard [options]\n"
            "Options:\n"
            " --help                 This help page\n"
            ...
            " --forcegrab            Starts the game in a window [and grabs mouse]\n"
